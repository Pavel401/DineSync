...
class WaiterProfileView extends StatefulWidget {
  final UserModel userModel;

  WaiterProfileView({super.key, required this.userModel});

  @override
  State<WaiterProfileView> createState() => _WaiterProfileViewState();
}

class _WaiterProfileViewState extends State<WaiterProfileView> {
